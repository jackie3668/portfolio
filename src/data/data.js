const projects = [
  ...
  },
  {
    ...
    description: "Front-end development project for an e-commerce jewelry site, created using React. The design embraces an elegant pastel pink theme, with prototyping done in Figma and Canva.",
    imageUrls: [
      require("../asset/project/project02/Preview-2.png"),
      require("../asset/project/project02/Preview-1.png"),
      require("../asset/project/project02/Preview-3.png"),
      require("../asset/project/project02/Preview-4.png"),
      require("../asset/project/project02/Preview-5.png"),
      require("../asset/project/project02/Preview-6.png"),
      require("../asset/project/project02/Preview-7.png"),
    ],
    linkUrl: "https://jackie3668.github.io/glimmering-grove/"
  },
  {
    id: "03",
    type: "Front End",
